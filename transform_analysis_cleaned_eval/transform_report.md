...
## Scaling benchmark (logistic regression, sampled)

| pipeline | roc_auc | accuracy | n_train | n_test | n_features_out |
| --- | --- | --- | --- | --- | --- |
| standard | 0.999609 | 0.986917 | 48000 | 12000 | 244 |
| minmax | 0.999349 | 0.989833 | 48000 | 12000 | 244 |

Interpretation:
- If `standard` beats `minmax`, standardization is the better default for your chosen model family.
- If results are close, prefer standardization (more common for linear models) unless your downstream model specifically benefits from [0,1] ranges (some neural nets / distance-based methods).
